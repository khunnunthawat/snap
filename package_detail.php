        ...
        <div class="container" align=center>
            ...
            <div class="profile-menu">
                <div class="profile-menu-container" style="width: auto;">
                    <div class="profile-menu-item-container">
                        <a href="/snap/package_detail.php" class="profile-menu-item active">
                            <i style="margin-right: 10px;"></i>รายละเอียดงาน
                        </a>
                    </div>
                    <div class="profile-menu-item-container">
                        <a href="/snap/package_detail_portfolio.php" class="profile-menu-item">
            ...
            <div class="detail-info">
                ...
                <div class="detail-info-list">
                    <div class="row">
                        <div class="col-6">
                            <div class="detail-info-box_list">
                                <div class="head-info">
                                    <p> รายละเอียดงาน </p>
                                    <p> รายละเอียดงาน </p>
                                    <p> รายละเอียดงาน </p>
